  ...
  useEffect(() => {
    ...
    sections.forEach((section: Section, index: number) => {
      if (index === 0) {
        ...
        if (sections[index + 1]) {
          section.isActive =
            sections[index + 1].boundingTop > offsetY + marginTop && sections[index].boundingTop <= offsetY + marginTop
        } else {
            ...
            <TimelineItem key={index}>
              ...
              <TimelineContent>
                <span
                  ...
                  style={{
                    textDecoration: 'none',
                    color: section.isActive ? customTheme.palette.secondary.main : customTheme.palette.text.primary,
